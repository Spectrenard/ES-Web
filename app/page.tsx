...
export default function Home() {
  return (
    <div className="bg-gradient-to-b from-neutral-900 to-neutral-950 min-h-svh">
      {/* Hero Section */}
      <section className="container mx-auto px-4 py-32 text-white relative">
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          <p className="text-xl text-gray-400 mb-12 leading-relaxed">
            La plateforme tout-en-un pour développer et déployer vos projets en
            un temps record. Propulsée par l'IA pour une productivité maximale.
          </p>
